...
$(document).ready(function () {
    ...
    var chart2 = new Highcharts.Chart('diagram2', {
        xAxis: {
            categories: ['Доверие клиента', 'Узнаваемость', 'Лояльность к бренду']
        },
        series: [{
            name: 'Хороший логотип',
            data: [87, 68, 77]
        }, {
            name: 'Слабый логотип',
            data: [48, 61, 37]
        }, {
            name: 'Устаревший бренд',
            data: [18, 10, 24]
        }],
    });

    var chart3 = new Highcharts.Chart('diagram3', {
        xAxis: {
            categories: ['Доверие клиента', 'Узнаваемость', 'Лояльность к бренду']
        },
        series: [{
    ...
    var chart1 = new Highcharts.Chart('diagram4', {
        xAxis: {
            categories: ['Доверие клиента', 'Узнаваемость', 'Лояльность к бренду']
        },
        series: [{
    ...
    var chart1 = new Highcharts.Chart('diagram', {
        xAxis: {
            categories: ['Доверие клиента', 'Узнаваемость', 'Лояльность к бренду']
        },
        series: [{
